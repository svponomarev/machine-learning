...
/**                        DISCPP.H                            **/
/**                                                            **/
/** INCLUDE file for DISLIN C++ programs.                      **/
/**                                                            **/
/** Date     : 18.03.2016                                      **/
/** Functions: 784 + 78                                        **/
/** Version  : 10.6                                            **/
...
#define LINE_DOT                1
#define LINE_DASH               2
#define LINE_CHNDSH             3
#define LINE_CHNDOT             4
#define LINE_DASHM              5
#define LINE_DOTL               6
#define LINE_DASHL              7
...
class Dislin
{
  public:
    ...
    void  arcell (int nx, int ny, int na, int nb, double a, double b, 
                  double t);
    ...
    void  bars3d (const float *xray, const float *yray, const float *z1ray, 
                  const float *z2ray, const float *xwray, 
                  const float *ywray, const int *icray, int n);
    void  bars3d (const double *xray, const double *yray, const double *z1ray, 
                  const double *z2ray, const double *xwray, 
                  const double *ywray, const int *icray, int n);
    ...
    void  bfcclr (int ic);
    void  bfcmsh (int ic);
    static short bitsi2 (int nbits, unsigned short mher, int iher, 
                 unsigned short mhin, int ihin);
    static int   bitsi4 (int nbits, unsigned int mher,int iher, 
                 unsigned int mhin, int ihin);
    ...
    void  circ3p (double x1, double y1, double x2, double y2, 
                  double x3, double y3, double *xm, double *ym, double *r);
    ...
    void  complx (void);
    void  conang (double xang);
    void  conclr (const int *nray, int n);
    void  concrv (const float *xray, const float *yray, int n, double zlev);
    ...
    void  confll (const float *xray, const float *yray, const float *zray,
                  int n, const int *i1ray, const int *i2ray, const int *i3ray,
                  int ntri, const float *zlev, int nlev);
    void  confll (const double *xray, const double *yray, const double *zray,
                  int n, const int *i1ray, const int *i2ray, const int *i3ray,
                  int ntri, const double *zlev, int nlev);
    void  congap (double xfac);
    void  conlab (const char *clab);
    void  conmat (const float *zmat, int n, int m, double zlev);
    ...
    void  conpts (const float *xray, int n, const float *yray, int m, 
                  const float *zmat, double zlev, float *xpts, float *ypts, 
    ...
    void  conshd3d (const double *xray, int n, const double *yray, int m, 
                  const double *zmat, const double *zlev, int nlev);
    void  contri (const float *xray, const float *yray, const float *zray, 
                  int n, 
                  const int *i1ray, const int *i2ray, const int *i3ray, 
                  int ntri, double zlev);
    void  contri (const double *xray, const double *yray, const double *zray, 
                  int n, 
                  const int *i1ray, const int *i2ray, const int *i3ray, 
                  int ntri, double zlev);
    void  contur (const float *xray, int n, const float *yray, int m,
                  const float *zmat, double zlev);
    ...
    void  crvqdr (const float *xray, const float *yray, const float *zray, 
                  int n); 
    ...
    void  crvtri (const float *xray, const float *yray, const float *zray,
                  int n, const int *i1ray, const int *i2ray, const int *i3ray,
                  int ntri);
    void  crvtri (const double *xray, const double *yray, const double *zray,
                  int n, const int *i1ray, const int *i2ray, const int *i3ray,
                  int ntri);
    int   csrkey (void);
    ...
    void  curv3d (const float *xray, const float *yray, const float *zray,
                  int n);
    void  curv3d (const double *xray, const double *yray, const double *zray,
                  int n);
    void  curv4d (const float *xray, const float *yray, const float *zray, 
                  const float *wray, int n);
    ...
    void  curve3 (const float *xray, const float *yray, const float *zray,
                  int n);
    void  curve3 (const double *xray, const double *yray, const double *zray,
                  int n);
    void  curvmp (const float *xray, const float *yray, int n);
    void  curvmp (const double *xray, const double *yray, int n);
    void  curvx3 (const float *xray, double y, const float *zray, int n);
    void  curvx3 (const double *xray, double y, const double *zray, int n);
    void  curvy3 (double x, const float *yray, const float *zray, int n);
    ...
    void  field3d (const float *x1ray, const float *y1ray, 
                  const float *z1ray, const float *x2ray, 
                  const float *y2ray, const float *z2ray, int n, int ivec);
    void  field3d (const double *x1ray, const double *y1ray, 
                  const double *z1ray, const double *x2ray, 
                  const double *y2ray, const double *z2ray, int n, int ivec);
    ...
    void  fitscls (void);
    double fitsflt (const char *ckey);
    ...
    void  gapsiz (double xgap, const char *cax);
    ...
    char *getfil (void);
    int   getgrc (void);
    void  getgrf (double *a, double *e, double *org, double *step, 
                  const char *cax);
    int   gethgt (void);
    int   gethnm (void);
    ...
    void  getmat (const float *xray, const float *yray, const float *zray,
                  int n, float *zmat, int nx, int ny, double zval, int *imat,
                  float *wmat);
    void  getmat (const double *xray, const double *yray, const double *zray,
                  int n, double *zmat, int nx, int ny, double zval, int *imat,
                  double *wmat);
    char *getmfl (void);
    ...
    void  grafmp (double xa, double xe, double xorg, double xstp,
                  double ya, double ye, double yorg, double ystp);
    void  grafp  (double xe, double xorg, double xstp, double yorg, 
                  double ystp);
    ...
    void  intax  (void);
    static int   intcha (int nx, char *cstr);
    static int   intlen (int nx);
    static int   intrgb (double xr, double xg, double xb);
    int   intutf (const int *iray, int n, char *cstr, int nmax);
    void  isopts (const float *xray, int nx, const float *yray, int ny, 
                  const float *zray, int nz, const float *wmat, double wlev,
    ...
    void  map    (const char *ct, const char *copt);
    ...
    void  piecbk (void (*callbck) (int iseg, double xdat, double xper, 
                  int *nrad, int *noff, double *angle, int *nvx, int *nvy, 
                  int *idrw, int *iann));
    ...
    void  pike3d (double x1, double y1, double z1, 
                  ...
                  int nsk1, int nsk2); 
    void  plat3d (double xm, double ym, double zm, double xl, 
                  const char *copt); 
    ...
    void  polar  (double xe, double xorg, double xstp, double yorg, 
                  double ystp);
    void  polcrv (const char *cpol);
    int   polclp (const float *xray, const float *yray, int n, 
              float *xout, float *yout, int nmax, double xv, 
              const char *cedge);
    ...
    void  pos3pt (double x, double y, double z, double *xp, double *yp, 
                  double *zp);
    ...
    void  qplcrv (const float *xray, const float *yray, int n, 
                  const char *copt);
    void  qplcrv (const double *xray, const double *yray, int n, 
                  const char *copt);
    ...
    void  qplscl (double a, double e, double org, double stp, 
                  const char *copt);
    ...
    void  revscr (void);
    void  rgbhsv (double xr, double xg, double xb, double *xh, double *xs, 
                  double *xv);
    ...
    void  sector (int nx, int ny, int nr1, int nr2, double a, double b,
                  int ncol);
    void  selwin (int id);
    void  sendbf (void);
    void  sendmb (void);
    ...
    void  setgrf (const char *c1, const char *c2, const char *c3, 
                  const char *c4);
    ...
    void  shdafr (const int *inray, const long *ipray, const int *icray, 
                  int n);
    void  shdasi (const int *inray, const long *ipray, const int *icray,
                  int n);
    void  shdaus (const int *inray, const long *ipray, const int *icray,
                  int n);
    void  shdcha (void);
    ...
    void  shdeur (const int *inray, const long *ipray, const int *icray, 
                  int n);
    void  shdfac (double xfac);
    void  shdmap (const char *cmap);
    void  shdmod (const char *copt, const char *ctyp);
    void  shdnor (const int *inray, const long *ipray, const int *icray,
                  int n);
    void  shdpat (long ipat);
    void  shdsou (const int *inray, const long *ipray, const int *icray, 
                  int n);
    void  shdusa (const int *inray, const long *ipray, const int *icray, 
                  int n);
    ...
    void  stmpts (const float *xmat, const float *ymat, int nx, int ny, 
                  const float *xp, const float *yp, double x0, double y0, 
    ...
    void  stmpts3d (const float *xv, const float *yv, const float *zv,
	          ...
	          const float *zp, double x0, double y0, double z0, 
    ...
    void  stmpts3d (const double *xv, const double *yv, const double *zv,
	          ...
	          const double *zp, double x0, double y0, double z0, 
                  double *xray, double *yray, double *zray, int nmax, 
                  int *nray);
    ...
    void  surshc (const float *xray, int n, const float *yray, int m, 
    ...
    void  surtri (const float *xray, const float *yray, const float *zray,
                  int n, const int *i1ray, const int *i2ray, const int *i3ray, 
                  int ntri);
    void  surtri (const double *xray, const double *yray, const double *zray,
                  int n, const int *i1ray, const int *i2ray, const int *i3ray, 
                  int ntri);
    void  survis (const char *cvis);
    static void  swapi2 (short *iray, int n);
    static void  swapi4 (int *iray, int n);
    ...
    void  swgtbl (int id, double *xray, int nray, int ndig, int idx, 
                  const char *copt);
    void  swgtbs (int id, const char *cstr, int irow, int icol, 
                  const char *copt);
    ...
    int   triang (double *xray, double *yray, int n, 
                  int *i1ray, int *i2ray, int *i3ray, int nmax); 
    void  triflc (const float *xray, const float *yray, const int *iray, 
                  int n);
    void  triflc (const double *xray, const double *yray, const int *iray, 
                  int n);
    void  trifll (const float *xray, const float *yray);
    void  trifll (const double *xray, const double *yray);
    void  triplx (void);
    void  tripts (const float *xray, const float *yray, const float *zray, 
                  int n, const int *i1ray, const int *i2ray, const int *i3ray,
                  int ntri, double zlev, float *xpts, float *ypts, 
                  int maxpts, int *nptray, int maxray, int *nlins);
    void  tripts (const double *xray, const double *yray, const double *zray, 
                  int n, const int *i1ray, const int *i2ray, const int *i3ray,
                  int ntri, double zlev, double *xpts, double *ypts, 
                  int maxpts, int *nptray, int maxray, int *nlins);
    static int   trmlen (const char *cstr);
    ...
    int   wgappb (int ip, const unsigned char *iray, int nw, int nh);
    ...
    int   wgdraw (int ip);
    int   wgfil  (int ip, const char *clab, const char *cstr, 
                  const char *cmask);
    void  wgfin  (void);
    ...
    int   wgpopb (int ip, const unsigned char *iray, int nw, int nh);
    int   wgquit (int ip);
    ...
    void  zbffin (void);
    int   zbfini (void);
    void  zbflin (double x1, double y1, double z1, double x2, double y2, 
                  double z2);
    void  zbfmod (const char *copt);
    void  zbfres (void);
    void  zbfscl (double x);
    void  zbftri (const float *x, const float *y, const float *z, 
                  const int *ic);
    void  zbftri (const double *x, const double *y, const double *z, 
                  const int *ic);
